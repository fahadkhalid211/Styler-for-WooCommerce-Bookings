...
<div class="wcbs-summary-card">
	<div class="wcbs-summary-header">
		...
		<div class="wcbs-summary-product-info">
			<h4 class="wcbs-summary-title"><?php echo esc_html( $product ? $product->get_name() : __( 'Your Booking', 'styler-for-woo' ) ); ?></h4>
			<span class="wcbs-summary-badge"><?php esc_html_e( 'Appointment Summary', 'styler-for-woo' ); ?></span>
		</div>
	</div>
	...
	<div class="wcbs-summary-details">
		...
		<div class="wcbs-summary-row wcbs-summary-resource" style="display:none;">
			<div class="wcbs-summary-label">
				...
				<span><?php esc_html_e( 'Staff / Resource:', 'styler-for-woo' ); ?></span>
			</div>
		...
		<div class="wcbs-summary-row wcbs-summary-date">
			<div class="wcbs-summary-label">
				...
				<span><?php esc_html_e( 'Date:', 'styler-for-woo' ); ?></span>
			</div>
			<div class="wcbs-summary-val wcbs-val-date"><?php esc_html_e( 'Select a date', 'styler-for-woo' ); ?></div>
		</div>
		...
		<div class="wcbs-summary-row wcbs-summary-time">
			<div class="wcbs-summary-label">
				...
				<span><?php esc_html_e( 'Time Slot:', 'styler-for-woo' ); ?></span>
			</div>
			<div class="wcbs-summary-val wcbs-val-time"><?php esc_html_e( 'Select a time', 'styler-for-woo' ); ?></div>
		</div>
		...
		<div class="wcbs-summary-row wcbs-summary-persons" style="display:none;">
			<div class="wcbs-summary-label">
				...
				<span><?php esc_html_e( 'Guests / Persons:', 'styler-for-woo' ); ?></span>
			</div>
	...
	<div class="wcbs-summary-cost-box">
		<div class="wcbs-summary-cost-label"><?php esc_html_e( 'Calculated Total:', 'styler-for-woo' ); ?></div>
	...
	<div class="wcbs-summary-guarantee">
		...
		<span><?php esc_html_e( 'Instant Booking Confirmation', 'styler-for-woo' ); ?></span>
	</div>
</div>
