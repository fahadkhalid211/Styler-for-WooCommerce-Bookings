...
$btn_text   = get_post_meta( $product_id, '_wcbs_drawer_btn_text', true ) ?: $settings->get( 'drawer_button_text', __( 'Book Appointment', 'styler-for-woocommerce-bookings' ) );
	...
	<?php if ( 'drawer' === $layout || 'modal' === $layout ) : ?>
		...
		<div class="wcbs-popup-container wcbs-popup-<?php echo esc_attr( $layout ); ?> wcbs-drawer-<?php echo esc_attr( $pos ); ?>" style="display:none;" role="dialog" aria-modal="true">
			<div class="wcbs-popup-header">
				<h3 class="wcbs-popup-title"><?php echo esc_html( $product ? $product->get_name() : __( 'Book Appointment', 'styler-for-woocommerce-bookings' ) ); ?></h3>
				<button type="button" class="wcbs-popup-close-btn" aria-label="<?php esc_attr_e( 'Close', 'styler-for-woocommerce-bookings' ); ?>">
		...
		<div class="wcbs-wizard-nav" role="tablist">
			<div class="wcbs-wizard-step active" data-step="1">
				...
				<div class="wcbs-step-meta">
					<span class="wcbs-step-label"><?php esc_html_e( 'Step 1', 'styler-for-woocommerce-bookings' ); ?></span>
					<span class="wcbs-step-title"><?php esc_html_e( 'Service & Staff', 'styler-for-woocommerce-bookings' ); ?></span>
				</div>
			</div>
			...
			<div class="wcbs-wizard-step" data-step="2">
				...
				<div class="wcbs-step-meta">
					<span class="wcbs-step-label"><?php esc_html_e( 'Step 2', 'styler-for-woocommerce-bookings' ); ?></span>
					<span class="wcbs-step-title"><?php esc_html_e( 'Date & Time', 'styler-for-woocommerce-bookings' ); ?></span>
				</div>
			</div>
			<div class="wcbs-wizard-divider"></div>
			<div class="wcbs-wizard-step" data-step="3">
				...
				<div class="wcbs-step-meta">
					<span class="wcbs-step-label"><?php esc_html_e( 'Step 3', 'styler-for-woocommerce-bookings' ); ?></span>
					<span class="wcbs-step-title"><?php esc_html_e( 'Guests & Details', 'styler-for-woocommerce-bookings' ); ?></span>
				</div>
			</div>
			<div class="wcbs-wizard-divider"></div>
			<div class="wcbs-wizard-step" data-step="4">
				...
				<div class="wcbs-step-meta">
					<span class="wcbs-step-label"><?php esc_html_e( 'Step 4', 'styler-for-woocommerce-bookings' ); ?></span>
					<span class="wcbs-step-title"><?php esc_html_e( 'Confirm & Pay', 'styler-for-woocommerce-bookings' ); ?></span>
				</div>
			</div>
		</div>
	<?php endif; ?>
